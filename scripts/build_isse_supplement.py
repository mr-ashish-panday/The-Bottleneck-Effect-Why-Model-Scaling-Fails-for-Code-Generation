#!/usr/bin/env python3
"""Build the ISSE reviewer-facing supplementary artifact ZIP."""
...
SUBMISSION = ROOT / "submission_isse_20260527"
OUT = SUBMISSION / "isse_supplement_artifact_full.zip"
TMP_OUT = OUT.with_suffix(OUT.suffix + ".tmp")
LISTING = SUBMISSION / "supplement_zip_listing.txt"
ZIP_DATE = (2026, 5, 27, 0, 0, 0)

ROOT_FILES = [
    "ARTIFACT_README.md",
    "ISSE_ARTIFACT_README.md",
    "ISSE_CLAIM_ARTIFACT_AUDIT.md",
    "ISSE_PORTAL_METADATA.md",
    "README.md",
    "bottleneck.pdf",
    "bottleneck.tex",
    "config.yaml",
    "isse_cover_letter.txt",
    "isse_highlights.txt",
    "references.bib",
